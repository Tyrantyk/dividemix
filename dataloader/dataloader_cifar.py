...
class cifar_dataset(Dataset): 
    ...
    def __getitem__(self, index):
        if self.mode=='labeled':
            ...
            return self.transform[2](weak), self.transform[2](strong), index
        elif self.mode=='all':
...
class cifar_dataloader():  
    ...
    def run(self,mode,pred=[],prob=[]):
        if mode=='warmup':
            ...
            labeled_dataset = cifar_dataset(dataset=self.dataset, noise_mode=self.noise_mode, r=self.r, root_dir=self.root_dir,\
            ...
            unlabeled_dataset = cifar_dataset(dataset=self.dataset, noise_mode=self.noise_mode, r=self.r, root_dir=self.root_dir,\
